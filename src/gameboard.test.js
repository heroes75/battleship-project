...
describe("test first game board", () => {
    ...
    test("place the carrier horizontally at (0, 9)", () => {
        expect(gameboard_1.placeShipAtHorizontally(carrier, 0, 9)).toBe("impossible")
    })
    test("place the cruiser and  destroyer at the same line", () => {
        expect(gameboard_1.placeShipAtHorizontally(cruiser, 0, 1)).toBe("impossible")
    })
...
describe("test second game board", () => {
    ...
    test("place the submarine vertically at (9, 9)", () => {
        expect(gameboard_2.placeShipAtVertically(submarine, 9, 9)).toBe("impossible")
    })
    test("place the cruiser and  battleship at the same line", () => {
        expect(gameboard_2.placeShipAtHorizontally(cruiser, 9, 0)).toBe("impossible")
    })
